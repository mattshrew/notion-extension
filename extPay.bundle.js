(() => {
  var e = {
      261: function (e, r) {
        ...
        "undefined" != typeof globalThis
              ...
              const r =
                ...
                s = (e) => {
                    ...
                    t = (e, r) =>
                      function (s, ...g) {
                        if (g.length < r.minArgs)
                          throw new Error(
                            `Expected at least ${r.minArgs} ${n(
                              r.minArgs
                            )} for ${e}(), got ${g.length}`
                          );
                        if (g.length > r.maxArgs)
                          throw new Error(
                            `Expected at most ${r.maxArgs} ${n(
                              r.maxArgs
                            )} for ${e}(), got ${g.length}`
                          );
                  ...
                  const c = new g((e) =>
                    ...
                    d = ({ reject: s, resolve: g }, a) => {
                      e.runtime.lastError
                        ? e.runtime.lastError.message === r
                          ? g()
                          : s(e.runtime.lastError)
          ...
          void 0 === (a = "function" == typeof s ? s.apply(r, g) : s) ||
            (e.exports = a);
      },
    },
    r = {};
  function s(g) {
    ...
    var m = (r[g] = { exports: {} });
    return e[g].call(m.exports, m, m.exports, s), m.exports;
  }
  (() => {
    "use strict";
    var e = s(261);
    "undefined" != typeof window &&
      window.addEventListener(
        "message",
        (r) => {
          "https://extensionpay.com" === r.origin &&
            r.source == window &&
            (("fetch-user" !== r.data && "trial-start" !== r.data) ||
              e.runtime.sendMessage(r.data));
        },
        !1
      );
  })();
